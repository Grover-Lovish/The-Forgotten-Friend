    ...
    if request.user.is_authenticated:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                subject = "confirm your email @The Forgotten Friend - Log-In"
                data = {
                    'name' : user.username,
                ...
                message = render_to_string("email_confirmation.html",data)
                text_data = "click the button to register yourself as a new user"
                ...
                email.send()
                return render(request,'register.html',{"log" : True})
        content = {
            'form' : form,
            'title' : "Register",
        }
